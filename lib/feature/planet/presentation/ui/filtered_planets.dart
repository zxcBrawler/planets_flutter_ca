...
class FilteredPlanets extends StatefulWidget {
  final String? category;
  const FilteredPlanets({super.key, this.category});

  @override
  State<FilteredPlanets> createState() => _FilteredPlanetsState();
}

class _FilteredPlanetsState extends State<FilteredPlanets> {
  @override
  Widget build(BuildContext context) {
    switch (widget.category) {
      case 'min temp':
        return BlocProvider<PlanetsBloc>(
          create: (context) => service()..add(const GetPlanetsByTemp()),
          child: _buildList(),
        );
      case 'min radius':
        return BlocProvider<PlanetsBloc>(
          create: (context) => service()..add(const GetPlanetsByRadius()),
          child: _buildList(),
        );
      case 'min mass':
        return BlocProvider<PlanetsBloc>(
